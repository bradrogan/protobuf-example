...
type Thing struct {
	...
	ThingOne string `protobuf:"bytes,1,opt,name=thing_one,json=thingOne,proto3" json:"thing_one,omitempty"`
	ThingTwo string `protobuf:"bytes,2,opt,name=thing_two,json=thingTwo,proto3" json:"thing_two,omitempty"`
}
...
func (x *Thing) GetThingOne() string {
	if x != nil {
		return x.ThingOne
	}
	return ""
...
func (x *Thing) GetThingTwo() string {
	if x != nil {
		return x.ThingTwo
	}
	return ""
...
var file_dummy_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x6d, 0x79, 0x22, 0x41, 0x0a, 0x05, 0x54, 0x68, 0x69, 0x6e, 0x67, 0x12, 0x1b, 0x0a,
	0x09, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x5f, 0x6f, 0x6e, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x74, 0x68, 0x69, 0x6e, 0x67, 0x4f, 0x6e, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x74, 0x68,
	0x69, 0x6e, 0x67, 0x5f, 0x74, 0x77, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74,
	0x68, 0x69, 0x6e, 0x67, 0x54, 0x77, 0x6f, 0x42, 0x08, 0x5a, 0x06, 0x2f, 0x64, 0x75, 0x6d, 0x6d,
